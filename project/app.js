...
app.get('/', isAuthenticated, (req, res) => {
    res.render('index', {
        ...
        title: 'Dashboard | contactApp',
        rpl: 'img/logo rpl.png',
        judul: 'contactApp',
...
app.get('/data-siswa/add', isAuthenticated, (req, res) => {
    res.render('add-data', {
        title: 'Tambah Data Siswa | contactApp',
        rpl: 'img/logo rpl.png',
        judul: 'contactApp',
        layout: 'layouts/main-layout.ejs',
        errors: null
...
app.post('/data-siswa', isAuthenticated, 
    [
        ...
        body('nisn').custom(async (value) => {
            ...
            return true;
        }).isLength({ min: 3, max: 3 }).withMessage('NISN harus terdiri dari 10 digit angka').
        ...
        body('nik').custom(async (value) => {
            ...
            return true;
        }).isLength({ min: 8, max: 8 }).withMessage('NIK harus terdiri dari 16 digit angka').
        isNumeric().withMessage('NIK tidak valid!'),

        //? Validasi panjang digit NoKK 
        check('nokk', 'NoKK tidak valid!').isLength({ min: 8, max: 8 }).withMessage('NoKK harus terdiri dari 16 digit angka')
...
app.get('/data-siswa/detail/edit/:nisn', isAuthenticated, async (req, res) => {
    ...
    res.render('edit-data', {
        title: 'Edit Data Siswa | contactApp',
        rpl: 'img/logo rpl.png',
        judul: 'contactApp',
        layout: 'layouts/main-layout.ejs',
        errors: null,
...
app.get('/data-siswa/detail/:nisn', isAuthenticated, async (req, res) => {
    const siswa = await Siswa.findOne({ nisn: req.params.nisn });
    res.render('detail', {
        title: 'Detail Data Siswa | contactApp',
        rpl: 'img/logo rpl.png',
        judul: 'contactApp',
        layout: 'layouts/main-layout.ejs',
        siswa,
...
app.listen(port, () => {
    console.log(`Website contactApp | Listening at http://localhost:${port}`);
});